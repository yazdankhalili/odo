 ...
 * (process stack pointer) Cortex processor register
 */
extern void set_PSP(uint32_t topOfProcStack);
 ...
 * (main stack pointer) Cortex processor register
 */
extern void set_MSP(uint32_t topOfMainStack);
 ...
 * Reverse byte order in unsigned short value
 */
extern uint32_t REV16(uint16_t value);
 ...
 */
extern uint32_t RBIT(uint32_t value);
 ...
 */
extern uint8_t LDREXB(uint8_t *addr);
 ...
 * Exclusive LDR command
 */
extern uint16_t LDREXH(uint16_t *addr);
 ...
 */
extern uint32_t STREXB(uint8_t value, uint8_t *addr);
 ...
 * Exclusive STR command
 */
extern uint32_t STREXH(uint16_t value, uint16_t *addr);
